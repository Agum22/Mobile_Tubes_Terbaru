...
class CobaRegis extends StatefulWidget {
  const CobaRegis({Key? key}) : super(key: key);

  @override
  State<CobaRegis> createState() => _CobaRegisState();
}

class _CobaRegisState extends State<CobaRegis> {
  ...
  void hasil()async{
    ...
    if (await service.create(email: user.text, password: pass.text)){
